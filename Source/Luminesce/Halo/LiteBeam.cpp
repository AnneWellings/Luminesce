...
// Called every frame
void ALiteBeam::Tick(float DeltaTime)
{
...
FHitResult ALiteBeam::DoubleTraceCenter()
{
	FHitResult Hit;
...
void ALiteBeam::SetHitting(FHitResult& Hit)
{
...
void ALiteBeam::StartHitting(FHitResult& Hit)
{
	IsHitting = true;
...
void ALiteBeam::HitTimerEvent(FHitResult& Hit)
{
	if(GEngine)
